...
4. Das Dialogfeld **Domäne überprüfen** öffnet sich und bietet Ihnen die Werte, um den TXT-Eintrag in Ihrem DNS-Hostinganbieter zu erstellen.
    ...
    > [!TIP]
    > Stellen Sie sicher, dass Sie ein DNS-Alias erstellen /intune-classic/deploy-use/set-up-windows-phone-management-with-microsoft-intune), während Sie Änderungen an Ihrem DNS-Hostanbieter vornehmen.
