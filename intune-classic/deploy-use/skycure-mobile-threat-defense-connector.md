...
1.  [Skycure für die Verwendung von Azure Active Directory Single Sign-On konfigurieren /intune-classic/deploy-use/configure-skycure-to-use-azure-active-directory-single-sign-on)
