---
title: Verwenden von Intune-App-Konfigurationsrichtlinien | Intune in Azure (Vorschau) | Microsoft Docs
...
# <a name="how-to-use-intune-app-configuration-policies"></a>Verwenden von Intune-App-Konfigurationsrichtlinien
