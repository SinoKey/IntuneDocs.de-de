...
1.  Wählen Sie in der Workload **Apps verwalten** die Option **Verwalten** > **App-Schutzrichtlinien** aus.
...
- [iOS-Richtlinien](ios-app-protection-policy-settings.md)
- [Android-Richtlinien](android-app-protection-policy-settings.md)

## <a name="next-steps"></a>Nächste Schritte
[Überwachen der Verwaltungsrichtlinien für mobile Apps mit Microsoft Intune](monitor-app-protection-policies-with-microsoft-intune.md)
