...
**Falls Sie nicht die Vorschau von Intune in Azure verwenden**, wird in diesem Thema erläutert, wie Sie in der klassischen Intune-Konsole [App-Schutzrichtlinien erstellen](https://docs.microsoft.com/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune).
