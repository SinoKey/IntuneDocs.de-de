---
title: "Registrieren für eine 30-tägige kostenlose Testversion | Intune in Azure (Vorschau) | Microsoft Docs"
...
- Das Intune-Dashboard in Azure ([portal.azure.com](https://portal.azure.com)), auf dem Sie die [Funktionen von Intune im Azure-Portal](what-is-microsoft-intune.md) erkunden können.
...
Weitere Informationen zu [Intune in der Vorschau des Azure-Portals](what-is-microsoft-intune.md)
### <a name="classic-intune"></a>Klassisches Intune
Evaluierungsszenario: [Evaluieren der Verwaltung mobiler Geräte (MDM) in Microsoft Intune](https://docs.microsoft.com/intune/understand-explore/mobile-device-management-trial-guide-microsoft-intune)
