---
title: "Erstellen eines WLAN-Profils über einen vorinstallierten Schlüssel | Intune in Azure (Vorschau) | Microsoft Docs"
description: "Intune in Azure (Vorschau): Verwenden Sie ein benutzerdefiniertes Profil von Intune, um ein WLAN-Profil mit einem vorinstallierten Schlüssel zu erstellen."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
