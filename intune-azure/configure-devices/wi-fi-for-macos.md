...
# <a name="intune-wi-fi-settings-for-macos-devices-in-intune-azure-preview"></a>Intune-WLAN-Einstellungen für macOS-Geräte in der Vorschau von Intune in Azure
