...
- Aktivieren der automatischen Registrierung (Azure AD Premium erforderlich)
- CNAME-Registrierung
- Aktivieren der Massenregistrierung (Azure AD Premium und Windows Configuration Designer erforderlich)
...
Sie können die Registrierung für Ihre Benutzer vereinfachen, indem Sie einen DNS-Alias (Eintragstyp CNAME) erstellen, der Registrierungsanforderungen automatisch an Intune-Server umleitet. Wenn Sie keinen DNS-CNAME-Ressourceneintrag erstellen, müssen Benutzer beim Herstellen einer Verbindung mit Intune den Intune-Servernamen angeben.
