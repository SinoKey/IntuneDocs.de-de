...
| IsDeleted |Gibt an, ob dieser MAM-App-Datensatz aktualisiert wurde Wahr: MAM-App verfügt über einen neuen Datensatz mit aktualisierten Feldern in dieser Tabelle. Falsch: der neueste Datensatz für diese MAM-App. |Wahr/falsch |
| StartDateInclusiveUTC |Datum und Uhrzeit in UTC, als diese MAM-App im Data Warehouse erstellt wurde. |23.11.2016 12:00:00 |
| DeletedDateUTC |Datum und Uhrzeit in UTC, wenn IsDeleted auf Wahr geändert wird. |23.11.2016 12:00:00 |
...
| DeviceId |Geräte-ID Geräts, auf dem diese MAM-App installiert wurde |b66bc706-ffff-7437-0340-032819502773 |
| DeviceName |Gerätename des Geräts, auf dem diese MAM-App installiert wurde |„MyDevice“ |
| IsDeleted |Gibt an, ob dieser Datensatz der MAM-App-Instanz aktualisiert wurde Wahr: Diese MAM-App-Instanz verfügt über einen neuen Datensatz mit aktualisierten Feldern in dieser Tabelle. Falsch: der neueste Datensatz für diese MAM-App-Instanz. |Wahr/falsch |
...
| ApplicationInstanceKey |Schlüssel der App-Instanz, der mit diesem Eincheckvorgang der MAM-App in Verbindung gebracht wird |02.5.1900 12:00:00 |
| UserKey |Schlüssel des Benutzers, der mit diesem Eincheckvorgang der MAM-App in Verbindung gebracht wird |12.01.1900 12:00:00 |
| ApplicationKey |Schlüssel der MAM-App, der eingecheckt wurde |10.01.1900 12:00:00 |
| DeviceHealthKey |Schlüssel von DeviceHealth, der mit diesem Eincheckvorgang der MAM-App in Verbindung gebracht wird |02.01.1900 12:00:00 |
| PlatformKey |Stellt die Plattform des Diensts dar, der mit diesem Eincheckvorgang der MAM-App in Verbindung gebracht wird. |01.01.1900 12:00:00 |
...
| Eigenschaft | Beschreibung | Beispiel |
|---------|------------|--------|
| DeviceHealthKey |Eindeutiger Bezeichner des Geräts, der mit der Integrität im Data Warehouse – Ersatzschlüssel in Verbindung gebracht wird. |01.01.1900 12:00:00 |
| DeviceHealth |Eindeutiger Bezeichner des Geräts und dessen Integrität. Ähnlich wie DeviceHealthKey, jedoch ist der Bezeichner ein natürlicher Schlüssel. |01.01.1900 12:00:00 |
| DeviceHealthName |Stellt den Status des Geräts dar. Nicht verfügbar – keine Informationen zu diesem Gerät. Fehlerfrei: Gerät wurde nicht per Jailbreak manipuliert. Nicht Fehlerfrei: Gerät wurde per Jailbreak manipuliert. |Nicht verfügbar fehlerfrei nicht fehlerfrei |
...
| Eigenschaft | Beschreibung | Beispiel |
|---------|------------|--------|
| PlatformKey |Eindeutiger Bezeichner auf der Plattform im Data Warehouse – Ersatzschlüssel |123 |
| Plattform |Eindeutiger Bezeichner der Plattform. Ähnlich wie PlatformKey, ist jedoch ein natürlicher Schlüssel |123 |
| PlatformName |Plattformname |Nicht verfügbar Nicht Windows iOS Android |
