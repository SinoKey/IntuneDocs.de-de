...
Bevor Sie mit der Problembehandlung beginnen, stellen Sie sicher, dass Intune ordnungsgemäß konfiguriert wurde, um die Registrierung zu ermöglichen. Unter [Registrieren von Android- und Standard KNOX-Geräten](android-enroll.md) finden Sie Links zu den Registrierungsschritten für jede Plattform.
...
> Sie können das Erreichen der Kapazitätsgrenze für Geräteregistrierungen vermeiden, indem Sie Geräteregistrierungs-Manager verwenden, wie unter [Registrieren von Geräten mit dem Geräteregistrierungs-Manager](device-enrollment-manager-enroll.md) beschrieben.
>
