                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune im Azure-Portal</h3>
                                            <p>Microsoft Intune ist im Azure-Portal verfügbar. Erfahren Sie mehr zur Verwaltung von Geräten und Apps im neuen Portal. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Was ist Intune for Education?</h3>
                                            <p>Erfahren Sie, wie Sie täglich auszuführende Aufgaben mit Geräten in Kursräumen erledigen.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Grundlagen: Erstellen einer Gruppe und eines Benutzers. Registrieren von Geräten. Zuweisen von Richtlinien und Apps.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Mehr als 150 Lizenzen? Nutzen Sie Ihre FastTrack-Vorteile</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Wo ist meine Intune-Funktion in Azure jetzt?</h3>
                                            <p>Wenn Sie sich mit Intune in der klassischen Konsole auskennen, hilft dieser Artikel Ihnen, Ihr Feature in Intune unter Azure zu ermitteln.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">Hier finden Sie die gesamte Intune-Dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">Hier finden Sie die gesamte einführende Dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/plan-design/introduction">Hier finden Sie die gesamte Dokumentation zur Bereitstellung</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/device-enrollment">Hier finden Sie die gesamte Dokumentation zur Vorgehensweise</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Erhalten Sie Informationen zu bekannten Problemen in Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Behandeln von Problemen mit E-Mail-Profilen</h3>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">Hier finden Sie die gesamte Dokumentation zur Problembehandlung</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Möchten Sie die gesamte Dokumentation anzeigen? <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">Hier finden Sie die gesamte Intune-Dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Stellen und Beantworten von Fragen im Forum</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
