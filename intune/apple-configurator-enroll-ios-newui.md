...
description: "Erfahren Sie, wie Sie unternehmenseigene iOS-Geräte mit Apple Configurator und dem Setup-Assistenten registrieren (neue Benutzeroberfläche)."
keywords: 
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
>Wenn Ihre Seite für die **Geräteregistrierung** der folgenden Abbildung ähnelt, wurde Ihr Konto noch nicht für die neue Benutzeroberfläche aktualisiert, und Sie können diese Hilfeseite verwenden. Wechseln Sie zu [dieser Hilfeseite](apple-configurator-enroll-ios.md).
>
