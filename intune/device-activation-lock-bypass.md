...
2. Aktivieren Sie die **Kiosk**-Einstellung **Aktivierungssperre**.
3. Speichern Sie das Profil, und weisen Sie es den Geräten zu, auf denen Sie die Umgehung der Aktivierungssperre verwalten möchten.
