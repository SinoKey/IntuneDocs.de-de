...
## Verwaltungswebsites für Intune
 Unterschiedliche Verwaltungsaufgaben erfordern von Ihnen die Verwendung der folgenden administrativen Websites, auf die Sie mithilfe eines [unterstützten Webbrowsers](supported-web-browsers.md) zugreifen können..
...
- Als Mandantenadministrator können Sie sich auch dann zur Verwaltung des Abonnements am Office 365-Portal anmelden, wenn Ihrem Konto keine Lizenz für die Nutzung von Folgendem zugewiesen ist: [!INCLUDE[wit_nextref](../includes/wit_nextref_md.md)].
