...
## <a name="the-new-admin-experience-for-groups"></a>Die neue Administratoroberfläche für Gruppen
...
## <a name="migration-details"></a>Einzelheiten zur Migration
Nachfolgend finden Sie Einzelheiten darüber, wie Ihre Intune-Gruppen zu Azure AD-Sicherheitsgruppen migriert werden.

### <a name="migration-of-existing-groups"></a>Migration vorhandener Gruppen
...
### <a name="changes-in-hierarchical-views"></a>Änderungen in hierarchischen Ansichten
...
### <a name="attribute-conversion-during-migration"></a>Attributkonvertierung während der Migration
...
## <a name="migration-of-policies"></a>Migration von Richtlinien
