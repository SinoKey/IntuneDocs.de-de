...
# Anfordern von Support für Microsoft Intune
 Der Microsoft-Support bietet für Microsoft Intune Unterstützung bei allgemeinen technischen Fragen, der Vertriebsvorbereitung sowie bei Fragen zu Rechnungen und Abonnements. Der Support ist für kostenpflichtige Abonnements und für Testabonnements online und telefonisch verfügbar. Der technische Onlinesupport ist nur auf Englisch und Japanisch verfügbar. Nicht technischer Support ist in weiteren Sprachen verfügbar.

In diesem Thema wird erläutert, wie Sie eine Serviceanfrage stellen oder telefonischen Support in vielen Sprachen anfordern.
...
### Partner
Sie können einen Microsoft-Partner auswählen und Verwaltungsfunktionen einschließlich dem Erstellen von Tickets für Serviceanfragen delegieren.
...
|Schweregrad|Beschreibung von Vorgängen und Support|Microsoft Intune/Enterprise Mobility Suite<br /><br />Premier|Microsoft Intune/Enterprise Mobility Suite<br /><br />Professional|
|------------------|--------------------------------------|------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|
...
Personen mit Intune-Administratorrollen (einschließlich Mandanten- und Dienstadministratoren) sind zum Zugriff auf die Intune-Verwaltungskonsole und zur direkten Kommunikation mit Microsoft zu Intune-Serviceanfragen autorisiert. Diese Administratoren können auch Microsoft-Partner einschließen, die Sie als delegierte Administratoren angegeben haben.
...
[Allgemeine Tipps für die Problembehandlung für Microsoft Intune](general-troubleshooting-tips-for-microsoft-intune.md)
