...
- [Überwachen von App-Bereitstellungen in Microsoft Intune](/intune/deploy-use/monitor-apps-in-microsoft-intune)
- [Schützen von Unternehmensdaten auf mobilen Geräten vor Datenverlust](/intune/deploy-use/protect-app-data-using-mobile-app-management-policies-with-microsoft-intune)
