...
### [Querladen von branchenspezifischen Apps](deploy-use/sideload-apps-for-windows.md)
...
##### [Einrichten von Mobile Threat Defense](deploy-use/device-threat-protection-subscription-setup.md)
##### [Aktivieren von Mobile Threat Defense](deploy-use/device-threat-protection-enable.md)
##### [Bereitstellen von Mobile Threat Defense-Apps](deploy-use/device-threat-protection-apps.md)
##### [Aktivieren der Mobile Threat Defense-Konformitätsrichtlinie](deploy-use/device-threat-protection-policy.md)
...
### [Ein Android-Gerät mit Intune verwenden](EndUser/using-your-android-device-with-intune.md)
#### [Wie Ihre Android-Benutzer Apps erhalten](deploy-use/how-your-android-users-get-their-apps.md)
### [Ein iOS-Gerät mit Intune verwenden](EndUser/using-your-iOS-or-macos-device-with-intune.md)
#### [Wie Ihre iOS-Benutzer Apps erhalten](deploy-use/how-your-ios-users-get-their-apps.md)
### [Ein Windows-Gerät mit Intune verwenden](EndUser/using-your-windows-device-with-intune.md)
