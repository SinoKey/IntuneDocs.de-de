...
# Planung und Entwurf
## [Bereitstellungsplanung, Design und Implementierung](plan-design/introduction.md)
...
## [Migrieren](plan-design/intune-mdm-migration-guide.md)
### [Phase 1: Vorbereiten von Intune für MDM](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [Grundlegende Einrichtung](plan-design/migration-phase1-basic-setup.md)
#### [Konfigurieren von Richtlinien für die Verwaltung von Apps und Geräten](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [Konfigurieren von App-Schutzrichtlinien](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [Besondere Überlegungen bei der Migration](plan-design/migration-phase1-special-migration-considerations.md)
### [Phase 2: Die Migration](plan-design/migration-phase2-migration-campaign.md)
#### [Kommunikationsplan](plan-design/migration-phase2-communication-plan.md)
#### [Steuern der Einführung](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [typischer Migrationszyklus](plan-design/migration-phase2-typical-migration-cycle.md)
