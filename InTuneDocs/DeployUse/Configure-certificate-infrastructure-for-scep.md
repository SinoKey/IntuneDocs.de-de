...
In diesem Thema wird beschrieben, welche Infrastruktur Sie zum Erstellen und Bereitstellen von Zertifikatprofilen benötigen.
...
-  **Microsoft Intune-Zertifikatconnector**: Sie verwenden die Intune-Verwaltungskonsole zum Herunterladen des Installationsprogramms für den **Certificate Connector** (**ndesconnectorssetup.exe**). Führen Sie **ndesconnectorssetup.exe** dann auf dem Computer aus, auf dem Sie den Certificate Connector installieren möchten.
...
3. Der NDES-Server wird sehr lange URLs (Anfragen) empfangen. Deshalb müssen Sie zwei Registrierungseinträge hinzufügen.
...
6. Navigieren Sie zu http://*FQDN*/certsrv/mscep/mscep.dll. Sie sollten eine NDES-Seite ähnlich der folgenden sehen:
