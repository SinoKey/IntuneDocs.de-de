...
## Angeben von Richtlinieneinstellungen für die Windows-Firewall
...
### Konfigurieren vordefinierter Ausnahmen
...
|**Media Center Extenders**|Ermöglicht Media Center Extendern die Kommunikation mit Computern, auf denen Windows Media Center ausgeführt wird. Bei dieser Einstellung werden das Simple Service Discovery-Protokoll (SSDP) und qWave verwendet.|
