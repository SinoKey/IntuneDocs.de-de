...
|Name der Einstellung|Details|
|----------------|-----|
|**Verschlüsselung auf mobilem Gerät anfordern**<sup>1</sup>|Erfordert die Verschlüsselung der Dateien auf dem Gerät.|
...
|**Header "Nicht nachverfolgen" senden**|Hiermit wird ein DNT-Header (Do Not Track, nicht nachverfolgen) an besuchte Websites in Internet Explorer gesendet.|
