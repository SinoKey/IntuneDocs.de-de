...
- [Use custom policies to allow and block apps for Samsung KNOX devices (Verwenden von benutzerdefinierten Richtlinien zum Zulassen und Blockieren von Apps für Samsung KNOX-Geräte)](custom-policy-to-allow-and-block-samsung-knox-apps.md)
