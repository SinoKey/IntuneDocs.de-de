...
description: "Intune bietet eine Auswahl von integrierten allgemeinen Einstellungen, die Sie auf Mac OS X-Geräten konfigurieren können. Darüber hinaus können Sie das Apple Configurator-Tool verwenden, um benutzerdefinierte Einstellungen zu erstellen, die über Intune nicht verfügbar sind."
keywords: 
author: robstackmsft
manager: arob98
ms.date: 07/19/2016
...
Intune bietet eine Auswahl von integrierten allgemeinen Einstellungen, die Sie auf Mac OS X-Geräten konfigurieren können. Darüber hinaus können Sie das Apple Configurator-Tool verwenden, um benutzerdefinierte Einstellungen zu erstellen, die über Intune nicht verfügbar sind.
...
Aktivieren Sie in der Liste der **kompatiblen&amp; und nicht kompatiblen Apps für Mac OS X** die Einstellung **Verwaltete Einstellungen für Geräte**, und geben Sie eine Liste kompatibler oder nicht kompatibler Apps mit den folgenden Informationen an:
...
> 
> Intune ermöglicht das Erstellen eines Berichts mit Geräten, auf denen nicht kompatible Apps installiert sind. Die Installation der Apps wird jedoch nicht verhindert, und nicht richtlinienkonforme Apps werden nicht entfernt.
...
Diese Funktion soll es Ihnen ermöglichen, Mac OS X-Einstellungen bereitzustellen, die nicht mit einer allgemeinen Intune-Konfigurationsrichtlinie für Mac OS X konfigurierbar sind.
